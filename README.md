...
**node-disk-storage** a simple fast and secure `local storage` for `nodejs`, you can store any data using key and value and your data will be **encrypt** to be like this `sh �+�)data|ZGF0YXxqb2huK2RvZV5eXiQwfDFd^^^$0|1`.
